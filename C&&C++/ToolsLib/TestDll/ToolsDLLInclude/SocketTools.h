...
//真实地关闭一个socket
TOOLSLIB_API inline void _Linux_Win_CloseSocket(Linux_Win_SOCKET nSocket)
{
...
#else // not WIN32
#endif
TOOLSLIB_API inline void Linux_Win_Socket_Init() //win 32 socket 初始化代码
{ 
#ifdef WIN32
...
TOOLSLIB_API inline void Linux_Win_Socket_Exit() //win32 socket 结束代码
{ 
#ifdef WIN32
...
//socket 注册管理类
class TOOLSLIB_API CSocketRegister
{ 
public:
