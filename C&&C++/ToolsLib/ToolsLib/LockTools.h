...
class TOOLSLIB_API CMint //int 型多线程安全变量类
{
public:
...
class TOOLSLIB_API CMbool //bool 型多线程安全的变量类
{
public:
...
class TOOLSLIB_API CMultiReadSingleWriteLock
{
public:
...
//不可重入锁
class TOOLSLIB_API CNonReentrant
{
public:
	CNonReentrant();
...
//线程控制锁
class TOOLSLIB_API CThreadManager
{ 
private:
