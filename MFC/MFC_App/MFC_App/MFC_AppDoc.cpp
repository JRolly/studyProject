...
// MFC_AppDoc.cpp : CMFC_AppDoc 类的实现
//
...
// 缩略图的支持
void CMFC_AppDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMFC_AppDoc::InitializeSearchContent()
{
...
void CMFC_AppDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
